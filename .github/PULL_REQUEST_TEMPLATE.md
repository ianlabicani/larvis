...
<!-- Explain the outcome of this pull request and the reason for the change. -->

Closes #<!-- issue number -->

## Testing

<!-- List the automated checks you ran and practical steps a reviewer can use to verify the change. -->

- [ ] Relevant automated tests pass.
- [ ] I manually verified the primary user flow or documented why manual testing does not apply.
